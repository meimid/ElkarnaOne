...
import com.meimid.core.model.TypeCompte;
...
public abstract class AbstractClassBase {
	...
	private List<TypeOperation>	typeOpList;
	 ...
	 * @return the listType
	 */
	public List<TypeCompte> getListTypeCompteList() {
		if (typeCompteList == null) {
	 ...
	 *            the listType to set
	 */
	public void setListTypeCompteList(final List<TypeCompte> listType) {
		this.typeCompteList = listType;
	}

	/**
	 * @return the listOp
	 */
	public List<TypeOperation> getTypeOpList() {
		if (typeOpList == null) {
	 ...
	 *            the listOp to set
	 */
	public void setTypeOpList(final List<TypeOperation> listOp) {
		this.typeOpList = listOp;
	}

	boolean isMobileDevice(final HttpServletRequest request) {
	...
	public   List<String> getTypeCompteCodeList() {
		if (typeCompteCodeList == null) {
			typeCompteCodeList = new ArrayList<String>();
			
			typeCompteCodeList.add("CCLIENT");
			typeCompteCodeList.add("CFOURN");
			typeCompteCodeList.add("CCHARGE");

		}
		return typeCompteCodeList;
	}
